            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <!-- Add icons to the links using the .nav-icon class
                   ...
                   <li class="nav-item">
                    ...
                    <a href="{{ url('dashboard/profile') }}" class="nav-link active">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              @endif
              @if (session("error"))
                <div class="alert alert-success text-center mt-1">{{ session('error') }}</div>
              @endif
              <form enctype="multipart/form-data" role="form" method="post" action="{{ route('profile.update') }}">
                @csrf
                @method('put')
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">نام </label>
                        <input value="{{ Auth::user()->name }}" type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="نام و نام خانوادگی خود را وارد کنید">
                      </div>

               
               
                  <div class="form-group">
                    <label for="exampleInputPassword1">کد مدرسه</label>
                    <input disabled value="{{ Auth::user()->school->code }}" type="text" name="schoolcode" class="form-control" id="exampleInputPassword1" placeholder="کد مدرسه را وارد کنید">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">مدرسه</label>
                    <select disabled name="school_id" class="form-control" id="">
                      <option selected value="{{ Auth::user()->school_id }}">{{ Auth::user()->school->name }}</option>
