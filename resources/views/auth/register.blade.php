        ...
        <div class="container-fluid h-custom">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-9 col-lg-6 col-xl-5">
              <img src="{{ asset('images/login/login.webp') }}"
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              <form method="POST" action="{{ route('register') }}">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                    ...
                    <label class="form-label" for="form3Example3">نام</label>
                  </div>
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                    <input name="password_confirmation" type="password" id="form3Example3" class="form-control form-control-lg"
                      placeholder="رمز عبور خود را دوباره وارد نمایید"/>
                    <label class="form-label" for="form3Example3">تکرار رمز عبور</label>
                  </div>
