                  ...
                  @endif
                   ...
                   <li class="nav-item">
                    ...
                    <li class="nav-item">
                      ...
                      <a href="{{ url('dashboard/teachers') }}" class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">افزودن معلم</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">افزودن معلم</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">افزودن معلم</h3>
              </div>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="form" role="form" method="POST" action="{{ route('dashboard.teachers.store') }}" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">نام معلم</label>
                        <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نام معلم را وارد کنید">
                      </div>
                    ...
                    <div class="form-group" id="divClass">
                        ...
                        <select name="class_id[]" id="class" class="selectpicker form-control" data-live-search="true" multiple>
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">تصویر معلم</label>
...
<script>
  ...
  select = document.querySelector('.selectpicker');
...
.then(data => {
  ...
  for (let i=0;i<arr.length;i++){
   ...
   span1.className = "bs-ok-default check-mark";
   span2.className = "text";
   span2.innerHTML = arr[i][1]["name"];
