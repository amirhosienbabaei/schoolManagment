      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">مشاهده معلم</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">مشاهده معلم</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">مشاهده معلم</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $user->name }}" disabled type="email" class="form-control" id="exampleInputEmail1" placeholder="نام معلم را وارد کنید">
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <input value="{{ $user->email }}" disabled type="email" class="form-control" id="exampleInputEmail1" placeholder="ایمیل را وارد کنید">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">کلاس</label>

                   
                    @foreach ($TeacherClasses as $class)
                    <input value="{{ $class->name->name }}" disabled type="text" class="form-control mt-1" id="exampleInputEmail1" placeholder="ایمیل را وارد کنید">
                    @endforeach
                  ...
                  <div class="form-group">
                    ...
                    <select disabled name="school_id" class="form-control" id="">
                  ...
                  <div class="form-group">
                    ...
                    <p>رمز عبور به دلیل مباحث امنیتی نمایش داده نمیشود</p>
                    {{-- <input value="" disabled type="password" class="form-control" id="exampleInputPassword1" placeholder="پسورد را وارد کنید"> --}}
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">تصویر معلم</label>
                    <div class="mb-2" class="input-group">
                      <div class="custom-file">
                        @if ($user->avatar)
                        <td><img src="{{ asset($user->avatar) }}" width="70px" height="70px" alt=""></td>
                          @else
