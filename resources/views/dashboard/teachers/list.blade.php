      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">معلمان</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">مدیریت معلم</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title" style="float: right;">داده معلم</h3>
                  ...
                  <tr>
                    ...
                    <td>
                     <div class="d-flex align-items-center justify-space-around">
                      ...
                      <a class="mr-1"  href="{{ route('dashboard.teachers.edit', ['teacher'=>$data->id]) }}">
                        <button class="btn btn-outline-primary btn-sm">ویرایش</button>
                        
                      </a>
                      
                      <a class="mr-1"  href="{{ route('dashboard.teachers.show', ['teacher'=>$data->id]) }}">
