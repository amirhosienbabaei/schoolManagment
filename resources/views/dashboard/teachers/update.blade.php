      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">ویرایش معلم</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">ویرایش معلم</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">ویرایش معلم</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              @if (session("success"))
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="form" role="form" method="POST" action="{{ route('dashboard.teachers.update', ['teacher'=>$user->id]) }}" enctype="multipart/form-data">
              @csrf
              @method('put')
              @if ($errors->any())
              ...
              @endif
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $user->name }}" name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نام معلم را وارد کنید">
                      </div>
                  ...
                  <div class="form-group" id="divClass">
                    ...
                    <select name="class_id[]" id="class" class="selectpicker form-control" data-live-search="true" multiple>
                          ...
                          @foreach ($teacher->classes as $class1)
                          @if ($class1->name->id === $class->id)
