      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">موارد انضباطی</h1>
            <p>
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">موارد انضباطی</li>
            </ol>
          </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title" style="float: right;">داده مورد انضباطی</h3>
              <a href="{{ route('dashboard.disciplineExamps.create') }}">
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     <div class="d-flex align-items-center justify-space-around">
                      ...
                      <a class="mr-1"  href="{{ route('dashboard.disciplineExamps.edit', ['disciplineExamp'=>$data->id]) }}">
                        <button class="btn btn-outline-primary btn-sm">ویرایش</button>
                        
                      </a>
                      
                      <a class="mr-1"  href="{{ route('dashboard.disciplineExamps.show', ['disciplineExamp'=>$data->id]) }}">
        ...
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`disciplineExamps/${idToSend}`, {
                        method: 'DELETE', 
                        headers: {
