      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">ایجاد مورد انضباطی</h1>
            <p>
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">ایجاد مورد انضباطی</li>
            </ol>
          </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">افزودن مورد انضباطی</h3>
              </div>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="form" role="form" method="POST" action="{{ route('dashboard.disciplineExamps.store') }}" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                ...
                <div class="card-body">
                    <div class="form-group">
                      ...
                      <select name="class_id" id="class_main" class="form-control select-picker col-12 mt-3">
                        <option disabled class="optionValues" value="">نام کلاس : نا مشخص</option>
                      ...
                      <select name="class_id" id="class_main" class="form-control select-picker col-12 mt-3">
                        <option disabled  selected class="optionValues" value="">نام کلاس : نا مشخص</option>
                      ...
                      <select name="student_id" id="student_main" class="form-control select-picker1 col-12 mt-3">
                        <option value="" disabled  class="optionValues1">نام دانش آموز : نا مشخص</option>
                      ...
                      <input type="text" class="form-control mt-3" name="dismissal_count" placeholder="در صورت نیاز به اخراج تعداد روز اخراج را وارد نمایید">

                      <input type="text" class="form-control mt-3" name="title" placeholder="موضوع را وارد کنید">

                      <input type="number" class="form-control mt-3" name="score" placeholder="نمره ای که قرار است از انضباط کم شود را وارد کنید">
