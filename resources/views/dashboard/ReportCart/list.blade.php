              ...
              <!-- Add icons to the links using the .nav-icon class
                  ...
                  @if (Auth::user()->type == 1 || Auth::user()->type == 2 || Auth::user()->type == 3)
                    ...
                    <li class="nav-item">
                      ...
                      <a href="{{ url('dashboard/reportCart') }}" class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">کارنامه ی تحصیلی</h1>
            <p>
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">کارنامه ی تحصیلی</li>
            </ol>
          </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title" style="float: right;">کارنامه تحصیلی</h3>
            ...
            <div class="card-body">
              ...
              @endif
                ...
                <form action="{{ route('dashboard.reportcart.store') }}" method="POST">
                  @csrf
              <div class="col-12  d-flex align-items-center justify-content-space-around" style="height: 500px;margin-top:20px">
                <div class="col-4" style="height: 250px;">
                  ...
                  <select name="position" id="position" class="form-control select-picker1 col-12 mt-1">
                  <option value="" selected disabled>ترم را انتخاب نمایید</option>
              ...
              <div  class="col-8" style="height: 500px; overflow-y:scroll">
                <div class="col-12 mt-5">
                  <div class="report-card text-dark">
                    ...
                    <!-- جمع‌بندی -->
                    <div class="footer">
                        <p> معدل : <strong>{{ session('moadel') ?? 'نا مشخص' }}</strong></p>
                    </div>
                    <div>
                      <button onclick="function(event){event.preventDefault(); window.print()}" class="btn btn-outline-success">چاپ کارنامه</button>
                    </div>
                </div>
              </div>
              <!-- /.card-body -->
