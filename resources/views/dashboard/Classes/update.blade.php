                  ...
                  @endif
                   <li class="nav-item">
                    ...
                    <li class="nav-item">
                      ...
                      <a href="{{ url('dashboard/classes') }}" class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">ویرایش کلاس</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">ویرایش کلاس</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="form" role="form" method="POST" action="{{ route('dashboard.classes.update', ['class'=>$class->id]) }}" enctype="multipart/form-data">
              @csrf
              @method('put')
              @if ($errors->any())
              ...
              @endif
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input value="{{ $class->name }}" name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نامکلاس را وارد کنید">
                  </div>
                  @if (Auth::user()->type == 1)
                    ...
                    <div class="form-group">
                      ...
                      <select name="school_id" class="form-control" id="">
                        <option selected value="{{ $class->school_id }}">{{ $class->school->name }}</option>
