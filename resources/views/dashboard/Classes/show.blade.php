      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">مشاهده کلاس</h1>
            <p>
              ...
              <form role="form">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $class->name }}" disabled type="email" class="form-control" id="exampleInputEmail1" placeholder="نام کلاس را وارد کنید">
                      </div>
