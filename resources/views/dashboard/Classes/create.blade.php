      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">ایجاد کلاس</h1>
            <p>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="form" method="POST" action="{{ route('dashboard.classes.store') }}" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نام کلاس را وارد کنید">
                    </div>
                    
                    @if (Auth::user()->type == 1)
                    <div  class="form-group" id="divClass">
                      <label for="exampleInputEmail1">انتخاب مکلاسه</label>
