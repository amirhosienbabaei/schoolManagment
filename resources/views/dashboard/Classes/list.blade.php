      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">کلاس ها</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">مدیریت کلاس</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title" style="float: right;">داده کلاس</h3>
              <a href="{{ route('dashboard.classes.create') }}">
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     <div class="d-flex align-items-center justify-space-around">
                      ...
                      <a class="mr-1"  href="{{ route('dashboard.classes.edit', ['class'=>$data->id]) }}">
                        <button class="btn btn-outline-primary btn-sm">ویرایش</button>
                        
                      </a>
                      
                      <a class="mr-1"  href="{{ route('dashboard.classes.show', ['class'=>$data->id]) }}">
