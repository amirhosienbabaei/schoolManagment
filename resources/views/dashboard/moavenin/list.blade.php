      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">معاونین</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">مدیریت معاونین</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title" style="float: right;">داده معاونین</h3>
              <a href="{{ route('dashboard.moavein.create') }}">
            ...
            <div class="card-body table-responsive">
              <table id=""  class="table table-bordered table-hover col-2 col-sm-12">
                <thead>
                <tr>
                  <th>شماره</th>
                  <th>نام </th>
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     <div class="d-flex align-items-center justify-space-around">
                      <form  class="mr-1" action="{{ route('dashboard.moavein.destroy', ['moavein'=>$data->id]) }}" method="POST">
                        @csrf
                        @method('delete')
                      </form>
                      ...
                      <a class="mr-1"  href="{{ route('dashboard.moavein.edit', ['moavein'=>$data->id]) }}">
                        <button class="btn btn-outline-primary btn-sm">ویرایش</button>
                        
                      </a>
                      
                      <a class="mr-1"  href="{{ route('dashboard.moavein.show', ['moavein'=>$data->id]) }}">
