      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">مشاهده درس</h1>
            <p>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">مشاهده درس</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $lesson->name }}" disabled type="email" class="form-control" id="exampleInputEmail1" placeholder="نام درس را وارد کنید">
                      </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">مدرسه</label>
                    <select disabled name="school_id" class="form-control" id="">
                      <option value="">{{ $lesson->school->name }}</option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select disabled name="school_id" class="form-control" id="">
                      <option value="">{{ $lesson->class->name }}</option>
                    </select>
                  </div>     
                  <div class="form-group">
                    <label for="exampleInputEmail1">معلم</label>
                    <select disabled name="school_id" class="form-control" id="">
                      <option value="">{{ $lesson->teacher->name }}</option>
                    </select>
                  </div>
...
<script>
  ...
  new Chart("myChart1", {
    ...
    options: {
      title: {
        display: true,
        text: "بیشترین غایبین موجود در درس ها"
      }
    }
  });
  </script>
