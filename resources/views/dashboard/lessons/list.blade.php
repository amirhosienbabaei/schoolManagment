        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title" style="float: right;">داده دروس</h3>
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     <div class="d-flex align-items-center justify-space-around">
                      ...
                      <a class="mr-1"  href="{{ route('dashboard.lessons.edit', ['lesson'=>$data->id]) }}">
                        <button class="btn btn-outline-primary btn-sm">ویرایش</button>
                        
                      </a>
                      
                      <a class="mr-1"  href="{{ route('dashboard.lessons.show', ['lesson'=>$data->id]) }}">
