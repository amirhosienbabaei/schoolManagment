      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6"  style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">مشاهده مدرسه</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">مشاهده مدرسه</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">مشاهده مدرسه</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form">
                <div class="card-body">
                  <div class="form-group">
                      ...
                      <input disabled value="{{ $school->name }}" name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نام مدرسه را وارد کنید">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">انتخاب مدیر</label>
                      <select disabled name="modir_id" class="form-control" id="">
                       
                            <option>{{ $school->user->name }}</option>
                ...
                <div class="form-group">
                  ...
                  <input disabled value="{{ $school->code }}" name="code" type="text" class="form-control" id="exampleInputEmail1" placeholder="کد مدرسه را وارد کنید">
                </div>
