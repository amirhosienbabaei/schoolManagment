      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6"  style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">ویرایش مدرسه</h1>
            <p>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="form" role="form" method="POST" action="{{ route('dashboard.schools.update', ['school'=>$school->id]) }}" enctype="multipart/form-data">
              @csrf
              @method('put')
              @if ($errors->any())
              ...
              <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">نام مدرسه</label>
                    <input value="{{ $school->name }}" name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نام مدرسه را وارد کنید">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">انتخاب مدیر</label>
                    <select name="modir_id" class="form-control" id="">
                      <option selected value="{{ $school->user_id }}">{{ $school->user->name }}</option>
                      @foreach ($modirs as $modir)
                      @if ($school->user_id == $modir->id)
                      <option hidden value="{{ $modir->id }}">{{ $modir->name }}</option>
                      @else
                      <option value="{{ $modir->id }}">{{ $modir->name }}</option>
                      @endif 
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">کد مدرسه</label>
                <input value="{{ $school->code }}" name="code" type="text" class="form-control" id="exampleInputEmail1" placeholder="کد مدرسه را وارد کنید">
              </div>
