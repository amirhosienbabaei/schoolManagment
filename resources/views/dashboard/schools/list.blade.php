      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">مدارس</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">مدیریت مدارس</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title" style="float: right;">داده مدارس</h3>
              ...
              <table id=""  class="table table-bordered table-hover col-2 col-sm-12">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ $i }}</td>
                    <td>{{ $schools->name }}</td>
                    <td>{{ $schools->user->name ?? 'نا مشخص' }}</td>
                    <td>

                     

                      <button class="btn btn-outline-danger btn-sm delete-btn" data-id="{{ $schools->id }}">حذف</button>


                      
                      <a class="mr-1"  href="{{ route('dashboard.schools.edit', ['school'=>$schools->id]) }}">
                        <button class="btn btn-outline-primary btn-sm">ویرایش</button>
                        
                      </a>
                      
                      <a class="mr-1"  href="{{ route('dashboard.schools.show', ['school'=>$schools->id]) }}">
