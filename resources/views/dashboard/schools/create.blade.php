      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">ایجاد مدرسه</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">افزودن مدرسه</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">افزودن مدرسه</h3>
              </div>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="form" role="form" method="POST" action="{{ route('dashboard.schools.store') }}" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نام مدرسه را وارد کنید">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="modir_id" class="form-control" id="">
                          @foreach ($modirs as $modir)
                              <option value="{{ $modir->id }}">{{ $modir->name }} {{ $modir->code }}</option>
                          @endforeach
                        </select>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <input name="code" type="text" class="form-control" id="exampleInputEmail1" placeholder="کد مدرسه را وارد کنید">
                  </div>
