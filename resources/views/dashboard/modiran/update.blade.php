              ...
              <!-- Add icons to the links using the .nav-icon class
                  ...
                  @endif
                   <li class="nav-item">
                      ...
                      <a href="{{ url('dashboard/moavenin') }}" class="nav-link">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="form" role="form" method="POST" action="{{ route('dashboard.modiran.update', ['modiran'=>$user->id]) }}" enctype="multipart/form-data">
              @csrf
              @method('put')
              @if ($errors->any())
