        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">مدیریت مدیران</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title" style="float: right;">داده مدیران</h3>
              <a href="{{ route('dashboard.modiran.create') }}">
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     <div class="d-flex align-items-center justify-space-around">
                      ...
                      <a class="mr-1"  href="{{ route('dashboard.modiran.edit', ['modiran'=>$data->id]) }}">
                        <button class="btn btn-outline-primary btn-sm">ویرایش</button>
                        
                      </a>
                      
                      <a class="mr-1"  href="{{ route('dashboard.modiran.show', ['modiran'=>$data->id]) }}">
