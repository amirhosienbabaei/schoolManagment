      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">ویرایش دانش آموز</h1>
            <p>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">ویرایش دانش آموز</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">ویرایش دانش آموز</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              @if (session("success"))
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="form" role="form" method="POST" action="{{ route('dashboard.students.update', ['student'=>$user->id]) }}" enctype="multipart/form-data">
              @csrf
              @method('put')
              @if ($errors->any())
              ...
              @endif
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $user->name }}" name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نام دانش آموز را وارد کنید">
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <input name="tell" value="{{ $student->phone }}" type="number" class="form-control" id="exampleInputEmail1" placeholder="شماره تلفن را وارد کنید">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">کد ملی</label>
                    <input name="codemelli" value="{{ $student->codemelli }}" type="number" class="form-control" id="exampleInputEmail1" placeholder="کد ملی را وارد کنید">
                  </div>

                  @if (Auth::user()->type == 1)
                  <div class="form-group">
                    <label for="exampleInputEmail1">انتخاب مدرسه</label>
                    <select name="school_id" onclick="hiddenSelect()" class="form-control" id="school">
                  ...
                  <div class="form-group" id="divClass">
                    ...
                    <select name="class_id"  id="class" class="selectpicker form-control">
