      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6" style="display: flex;align-items: center;justify-content: space-between">
            <h1 class="m-0 text-dark">افزودن دانش آموز</h1>
            <p>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">افزودن دانش آموز</h3>
              </div>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="form"  method="POST" action="{{ route('dashboard.students.store') }}" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">نام دانش آموز</label>
                        <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="نام دانش آموز را وارد کنید">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="school_id" class="form-control" id="school">
                         <option value="" class="optionValues" disabled selected>مدرسه ای را انتخاب کنید</option>
                    ...
                    <div class="form-group" id="divClass">
                        ...
                        <select name="class_id" id="class" class="form-control select-picker" data-live-search="true">
                      ...
                      <div class="form-group" id="divClass">
                        <label for="exampleInputEmail1">انتخاب کلاس</label>
                        <select name="class_id"  class="form-control select-picker" data-live-search="true">
                      ...
                      <div class="form-group">
                        ...
                        <input name="tell" type="number" class="form-control" id="exampleInputEmail1" placeholder="شماره تلفن را وارد کنید">
                      </div>

                      <div class="form-group">
                        <label for="exampleInputEmail1">کد ملی</label>
                        <input name="codemelli" type="number" class="form-control" id="exampleInputEmail1" placeholder="کد ملی خود  را وارد کنید">
                      </div>
                      
                  <div class="form-group">
                    <label for="exampleInputEmail1">آدرس ایمیل</label>
                    <input name="email" type="email" class="form-control" id="exampleInputEmail1" placeholder="ایمیل را وارد کنید">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input id="password1" min="8" max="14" name="password" type="password" class="form-control" id="exampleInputPassword1" placeholder="پسورد را وارد کنید">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1">تکرار رمز عبور</label>
                    <input id="password2" min="8" max="14" name="confirm" type="password" class="form-control" id="exampleInputPassword1" placeholder="پسورد را  دوباره وارد کنید">
                  </div>
...
.then(data => {
  ...
  let Element = document.createElement('option');
   ...
   document.querySelector('#class').appendChild(Element);
...
<script>
  document.querySelector('.filter-option-inner-inner').innerHTML = "چیزی انتخاب نشده است";
