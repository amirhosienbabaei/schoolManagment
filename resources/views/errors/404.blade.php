...
<head>
    ...
    <title> ساتا رندر | سامانه هوشمند مدیریت مدرسه</title>
...
<body>
    ...
    <div class="error">
      ...
      <div class="error__subtitle">ادرس مورد نظر یافت نشد.</div>
      <div class="error__description">آدرسی که دنبالشی وجود نداره ، دوباره تلاش کن</div>
    <a href="{{ route('login') }}">
        <button class="error__button error__button--active" style="padding: 20px;font-size:20px"> ورود به پنل مدیریت</button>
    </a>
